...
struct xaccel_func_desc
{
	...
	uint32_t cap		// Capabilities of this fucntion R/W
...
static inline bool xaccel_desc_magic_valid(const struct xaccel_desc_header *head);

// Is this Descriptor Version Supported?
static inline bool xaccel_desc_version_valid(const struct xaccel_desc_header *head);
